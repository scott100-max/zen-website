#!/usr/bin/env python3
"""
Build morning meditation using ElevenLabs TTS.
Better voice consistency than Fish Audio.
"""
import os
import subprocess
import requests
...
VOICE_ID = "AgKz2EVQ5tLBunArizde"  # Salus Meditation Voice (cloned from Fish)
OUTPUT = "content/audio/01-morning-meditation-elevenlabs.mp3"

# Voice settings for calm meditation
VOICE_SETTINGS = {
    "stability": 0.75,        # Higher = more consistent
    "similarity_boost": 0.75,
    "style": 0.0,             # Lower = less expressive, calmer
...
def main():
    ...
    print(f"Voice: George (Warm, Captivating Storyteller)")
    ...
    # Normalize to -24 LUFS and encode at 128kbps
    subprocess.run([
